...
namespace Tracer
{
    ...
    */
    ...
    // empty span for all jobs that does not have a trace ID.
    ...
    //
    void RPCServerSend(const TraceRec* span = nullptr);
    ...
    // them into windows perf counters.
    //

    void LogCounterValue(Counter counter, const wchar_t* counterInstance, uint64_t value, const TraceRec* span = nullptr);
